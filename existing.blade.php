...
$(document).ready(function () {
    ...
    $('.modal').on('shown.bs.modal', function (event) {
        ...
        // Initialize File Upload Preview for this modal only once
        const uploadId = 'uploadId' + modal.attr('id').replace('exampleModal', '');
        if (!modal.data('upload-initialized')) {
            new FileUploadWithPreview(uploadId);
            modal.data('upload-initialized', true);
        }
    });
